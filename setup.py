...
#
#     from PySlices import metadata
#
# However, when we do this, we also import `PySlices/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'PySlices_cli = PySlices.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'PySlices_gui = PySlices.gui:entry_point'
        # ]
    }
)
